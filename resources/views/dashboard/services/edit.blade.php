                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark" style="font-family: Comfortaa;font-size: 20px;">
                                <img src="{{url('dashboard/images/services/'.$service->image)}}" class="img-responsive" style="width: 70px;height: 70px;border-radius: 50%;"/>
                                Edit: {{str_limit($service->title , 30)}}</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <form method="post" action="{{url('service/update/'.$service->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 pull-left">
                                    ...
                                    <span class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <span class="col-md-4">
                                            <label>Title</label>
                                            <input id="name" type="text" class="form-control" name="name" value="{{ $service->title }}" placeholder="Title...">
                                    ...
                                    <span class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                                        ...
                                        <span class="col-md-4">
                                            ...
                                            <textarea id="body" class="form-control" name="body" rows="5" placeholder="Description ......">{{ $service->body }}</textarea>
                                            @if ($errors->has('body'))
                                                <span class="help-block">
                                ...
                                <div class="col-md-6 pull-right">{{--start div first col--}}
                                    ...
                                    <span class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                                            ...
                                            <span class="col-md-4">
                                                <label>Image</label>
                                                <input id="image" type="file" class="form-control" name="image" value="{{ $service->image }}" style="height: 38px; line-height: 18px;">
