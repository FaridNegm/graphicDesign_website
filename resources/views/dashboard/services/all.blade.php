        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid" style="background-color: #FFF; width: 90%;margin: 0px auto;padding: 30px 20px 20px;">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark" style="font-family: Comfortaa;font-size: 20px;"><i class="fa fa-angellist icon_title"></i> All Services</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div style="width: 100%;margin: 0px auto;padding: 30px 10px 20px;">
                            <div class="text-center"><a class="btn btn-primary" href="{{url('add-new-service')}}"><i class="fa fa-plus"></i> Add New Service</a></div>
                            <div class="card-body">
                                <table id="table" class="table table-striped">
                                    ...
                                    <tr>
                                            <td>{{$service->id}}</td>
                                            <td>{{$service->title}}</td>
                                            <td style="max-width: 220px;">{{str_limit($service->body  , 80)}}</td>
                                            <td>
                                                <img src="{{url('dashboard/images/services/'.$service->image)}}" class="img-responsive" style="width: 50px;height: 50px;border-radius: 50%;"/>
                                            </td>
                                            <td>{{$service->status}}</td>
                                            <td>
                                                <a href="{{url('service/edit/'.$service->id)}}" class="btn btn-info"><i class="fa fa-edit"></i> </a>
