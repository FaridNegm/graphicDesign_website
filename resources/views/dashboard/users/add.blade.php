        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid" style="background-color: #FFF; width: 90%;margin: 0px auto;padding: 30px 20px 20px;">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark" style="font-family: Comfortaa;font-size: 20px;"><i class="fa fa-user-plus icon_title"></i> Add New User</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div style="width: 90%;margin: 0px auto;padding: 30px 10px 20px;">
                            <form method="post" action="{{url('users/add-new-user')}}" enctype="multipart/form-data">
