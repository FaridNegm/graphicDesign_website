                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark" style="font-family: Comfortaa;font-size: 20px;">
                                <img src="{{url('dashboard/images/works/'.$work->image)}}" class="img-responsive" style="width: 70px;height: 70px;border-radius: 50%;"/>
                                Edit: {{str_limit($work->title , 30)}}</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{url('adminpanel')}}">Home</a></li>
                                <li class="breadcrumb-item active">Edit My Works</li>
                            </ol>
                        </div><!-- /.col -->
                            ...
                            <form method="post" action="{{url('work/update/'.$work->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 pull-left">
                                    ...
                                    <span class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <span class="col-md-4">
                                            <label>Title</label>
                                            <input id="name" type="text" class="form-control" name="name" value="{{ $work->title }}" placeholder="Title...">
                                    ...
                                    <span class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                                        ...
                                        <span class="col-md-4">
                                            ...
                                            <textarea id="body" class="form-control" name="body" rows="5" placeholder="Description ......">{{ $work->body }}</textarea>
                                            @if ($errors->has('body'))
                                                <span class="help-block">
                                ...
                                <div class="col-md-6 pull-right">{{--start div first col--}}
                                    ...
                                    <span class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                                        <label>Category</label>
                                        <span class="col-md-4">
                                            <select name="category"  id="category" class="form-control">
                                                <option value="{{$work->category}}" selected="selected">{{$work->category}}</option>
                                    ...
                                    <span class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                                            ...
                                            <span class="col-md-4">
                                                <label>Image</label>
                                                <input id="image" type="file" class="form-control" name="image" value="{{$work->image}}" style="height: 38px; line-height: 18px;">
                                    ...
                                    <span class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                                            ...
                                            <span class="col-md-4">
                                                ...
                                                <select name="status"  id="status" class="form-control">
                                                    <option selected="selected">{{$work->status == '1'? 'Active' : 'Not Active'}}</option>
