        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid" style="background-color: #FFF; width: 90%;margin: 0px auto;padding: 30px 20px 20px;">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark" style="font-family: Comfortaa;font-size: 20px;"><i class="fa fa-briefcase icon_title"></i> Add New Work</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{url('adminpanel')}}">Home</a></li>
                                <li class="breadcrumb-item active">Add New Work</li>
                            </ol>
                        </div><!-- /.col -->

                        <div style="width: 90%;margin: 0px auto;padding: 30px 10px 20px;">
                            <form method="post" action="{{url('add-new-work')}}" enctype="multipart/form-data">
                                @include('dashboard.my_works.form')
                            </form>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
